...
Easily create and publish PopUp and FlyIn Banners and campaigns on your WordPress Site.

== Description ==

Easily create and publish your specific events and products using CM PopUp Banners for WordPress! In each WordPress page you can add a particular banner fixed on the middle or bottom of the page or a post.

[youtube https://www.youtube.com/watch?v=BsAvS-FNeWI]

> #### Plugin Site
> * [Plugin Site](https://www.cminds.com/store/cm-pop-up-banners-plugin-for-wordpress/)
> * [Pro Version Detailed Features List](https://www.cminds.com/store/cm-pop-up-banners-plugin-for-wordpress/)
...
*  Allows to create Campaigns Items
*  Each Advertisement Item can have it's own HTML content (images, texts etc.)
*  Displays the Advertisement Item in the popup on the center or at the bottom right corner of the page/post screen
...
== Changelog ==
> [View Release Notes in CM PopUp Banners Plugin Site](https://www.cminds.com/store/cm-pop-up-banners-plugin-for-wordpress/)
>
== Screenshots ==
